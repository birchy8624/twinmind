...
export async function fetchClientSecret(): Promise<string> {
  if (!priceId) {
    console.error('checkout price configuration missing: STRIPE_PRICE_ID is not set')
    throw new Error('Checkout is temporarily unavailable. Please contact support to complete your upgrade.')
  }
