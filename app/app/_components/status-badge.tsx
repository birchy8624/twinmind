...
const statusStyles: Record<string, string> = {
  Active: 'bg-emerald-500/10 text-emerald-300 ring-1 ring-inset ring-emerald-500/40',
  ...
  Completed: 'bg-emerald-500/10 text-emerald-200 ring-1 ring-inset ring-emerald-500/40',
