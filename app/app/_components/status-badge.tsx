...
const statusStyles: Record<string, string> = {
  ...
  'Call Arranged': 'bg-sky-500/10 text-sky-200 ring-1 ring-inset ring-sky-500/40',
  'Brief Gathered': 'bg-amber-500/10 text-amber-200 ring-1 ring-inset ring-amber-500/40',
  'UI Stage': 'bg-purple-500/10 text-purple-200 ring-1 ring-inset ring-purple-500/40',
  'DB Stage': 'bg-cyan-500/10 text-cyan-200 ring-1 ring-inset ring-cyan-500/40',
  'Auth Stage': 'bg-indigo-500/10 text-indigo-200 ring-1 ring-inset ring-indigo-500/40',
  Build: 'bg-limeglow-500/10 text-limeglow-200 ring-1 ring-inset ring-limeglow-500/40',
  QA: 'bg-amber-500/10 text-amber-200 ring-1 ring-inset ring-amber-500/40',
  Handover: 'bg-emerald-500/10 text-emerald-200 ring-1 ring-inset ring-emerald-500/40',
  Closed: 'bg-zinc-500/10 text-zinc-200 ring-1 ring-inset ring-zinc-500/40',
