      ...
      >
        ...
        <div className="flex items-center justify-between gap-3 border-t border-white/10 bg-base-900/60 px-6 py-4">
          ...
          {activeStep === steps.length - 1 ? (
            <button
              type="submit"
              className="rounded-md bg-white px-4 py-2 text-sm font-semibold text-base-950 transition hover:bg-white/80"
            >
              Create project
            </button>
          ) : (
            <button
              type="button"
              onClick={handleNext}
              className="rounded-md bg-emerald-500/90 px-4 py-2 text-sm font-semibold text-emerald-950 transition hover:bg-emerald-400"
            >
              Continue
            </button>
          )}
